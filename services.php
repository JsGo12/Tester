                ...
                <div class="col-md-4 mb-4">
                  <div class="service-card">
                    ...
                    <div class="service-content">
                      ...
                      <a href="#" class="btn btn-primary add-to-cart" data-service="Asesoramiento">Agregar al carrito</a>
                    </div>
                  </div>
                </div>
                <div class="col-md-4 mb-4">
                  <div class="service-card">
                    <div class="service-img">
                      <img src="assets/img2/man_obra.png" alt="Checkeo" class="img-fluid">
                    </div>
                    <div class="service-content">
                      ...
                      <a href="#" class="btn btn-primary add-to-cart" data-service="Mano de obra">Agregar al carrito</a>
                    </div>
                  </div>
                </div>
                <div class="col-md-4 mb-4">
                  <div class="service-card">
                    <div class="service-img">
                      <img src="assets/img2/revision.png" alt="Checkeo" class="img-fluid">
                    </div>
                    <div class="service-content">
                      ...
                      <a href="#" class="btn btn-primary add-to-cart" data-service="Checkeo">Agregar al carrito</a>
                    </div>
                  </div>
                </div>
              </div>
